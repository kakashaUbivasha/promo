...
export default {
  ...
  data() {
    return {
      ...
      cards1: [
        {img: '/gosty.png', title: 'Gosty', discount: 'Каждый вторник — 20% на все меню', discountType: 'Скидки', description: 'Рестораны', date: 'До 29 февраля', isActive: false},
        {img: '/shosh.png', title: 'Shosh', discount: 'Скидки на еду и напитки', discountType: 'Скидки', description: 'Кафе', date: '71:59:59', isActive: true},
        {img: '/petrovich.png', title: 'Petrovich', discount: 'Ланч по выгодной цене и 2% кешбэк по промокоду', discountType: 'Скидки', description: 'Рестораны', date: 'До 29 февраля', isActive: false},
        {img: '/shosh.png', title: 'Shosh', discount: 'Скидки на еду и напитки', discountType: 'Скидки', description: 'Кафе', date: '71:59:59', isActive: true},
        {img: '/petrovich.png', title: 'Petrovich', discount: 'Ланч по выгодной цене и 2% кешбэк по промокоду', discountType: 'Скидки', description: 'Рестораны', date: 'До 29 февраля', isActive: false},
      ],
      cards: [
        {img: '/Korzinka.png', title: 'Korzinka.uz', discount: 'В четверг скидки на рыбу', discountType: 'Скидки', description: 'Супермаркеты', date: 'До 29 февраля', isActive: false},
        {img: '/Mango.png', title: 'MANGO', discount: 'Акция 1+1', discountType: 'Акции', description: 'Магазины брендовой одежды', date: '71:59:59', isActive: true},
        {img: '/Texnomart.png', title: 'TEXNOMART', discount: 'До — 60% на бытовую технику в ТЦ «Samarkand Darvoza»', discountType: 'Скидки', description: 'Магазины электроники и бытовой техники', date: 'До 29 февраля', isActive: false},
        {img: '/Makro.png', title: 'Makro', discount: 'При покупке CIF пачка губок Salixan БЕСПЛАТНО', discountType: 'Акции', description: 'Супермаркеты', date: 'До 29 февраля', isActive: false},
      ],
      faqs: [
